...
struct Resources {
  ...
  std::list <directordaemon::StorageResource*> read_storage_list{};     /**< Read storage possibilities */
  std::list <directordaemon::StorageResource*> write_storage_list{};    /**< Write storage possibilities */
  std::list <directordaemon::StorageResource*> paired_read_write_storage_list{}; /**< Paired storage possibilities (saved write_storage_list or read_storage_list) */
